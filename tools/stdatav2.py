...
from options.stdatav2_options import STDATAV2Options



if __name__ == "__main__":
    opt = STDATAV2Options().parse()   # get training options
    seed_torch(opt.seed)
    ...
    total_iters = 0
    model.refiter = fixstepiter(ref_dataset, opt.batch_size)
    model.fixiter = fixstepiter(ref_dataset, opt.batch_size)
