...
class STDATAV1Options(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--phase', type=str, default='stdatav1', help='specify the method')
        # base parameters
        ...
        parser.add_argument('--cussub', action='store_true', default=False, help='if specified, input the surrogate model you specified')
        ...
        parser.add_argument('--netG', type=str, default='CACWNG', help='choice of generator')
        ...
        parser.add_argument('--clsbatch', type=int, default=10, help='number of classes to generate')
        parser.add_argument('--basebatch', type=int, default=6, help='number of samples per class to generate')
        ...
        parser.add_argument('--loss', type=str, default='vanilla', help='choice of optimized objective functions for GAN')
        parser.add_argument('--probloss', type=str, default='L1Loss', help='choice of optimized objective functions for surrogate model')
